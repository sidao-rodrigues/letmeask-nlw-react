      ...
      <main>
        ...
        <form onSubmit={handleSendQuestion}>
          ...
          <div className="form-footer">
            ...
            <Button type="submit" disabled={!user}>fazer pergunta</Button>
          </div>
        </form>
          ...
          {questions.map(question => {
            return (
              <Question key={question.id} content={question.content} author={question.author} isAnswered={question.isAnswered} isHighlighted={question.isHighlighted}>
                {!question.isAnswered && (
                  <button className={`like-button ${question.likeId ? 'liked' : ''}`} type="button" aria-label="Marcar com gostei" onClick={() => handleLikeQuestion(question.id, question.likeId)}>
